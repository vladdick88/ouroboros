...
# Kimi For Coding pricing (2025-02) - per 1M tokens (input, cached, output) in USD
...
def _get_pricing() -> Dict[str, Tuple[float, float, float]]:
    """
    Lazy-load pricing. Returns static Moonshot pricing.
    ...
    with _pricing_lock:
        ...
        # Kimi pricing is static - no need to fetch
        pass
